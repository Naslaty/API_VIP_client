...
public class ApiClient {
    ...
    public String selectHeaderAccept(String[] accepts) {
        ...
        for (String accept : accepts) {
            if (isJsonMime(accept) || accept.equals("text/plain")) {	//TEST : || accept.equals("text/plain"), to come back to initial code take off the 2nd part condition, due to a une rubrique "produces" part of the specification which gives 2 format text/plain and application/json
                return accept;
            }
        }
